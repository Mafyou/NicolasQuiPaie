    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "#dc3545", "Propositions liées aux impôts et taxes", "fas fa-coins", true, "Fiscalité", 1 },
                    { 2, "#28a745", "Propositions sur l'utilisation de l'argent public", "fas fa-hand-holding-usd", true, "Dépenses Publiques", 2 },
                    { 3, "#007bff", "Amélioration des services publics", "fas fa-building", true, "Services Publics", 3 },
                    { 4, "#fd7e14", "Investissements dans les infrastructures", "fas fa-road", true, "Infrastructure", 4 },
                    { 5, "#6f42c1", "Financement et réforme de l'éducation", "fas fa-graduation-cap", true, "Éducation", 5 },
                    { 6, "#20c997", "Système de santé et financement", "fas fa-heartbeat", true, "Santé", 6 }
                });
