...
using InfrastructureModels = NicolasQuiPaieAPI.Infrastructure.Models;
...
public static class TestDataHelper
{
    ...
    public static ApplicationUser CreateTestUser(
        ...
        new()
        {
            ...
            {
                InfrastructureFiscalLevel.PetitNicolas => 100,
                InfrastructureFiscalLevel.GrosMoyenNicolas => 250,
                InfrastructureFiscalLevel.GrosNicolas => 500,
                InfrastructureFiscalLevel.NicolasSupreme => 1000,
                _ => 0
            },
            IsVerified = true,
